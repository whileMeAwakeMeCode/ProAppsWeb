...
const ClientsView = () => {
    ...
    return <div>
        ...
        <Modal
            ...
            content={<div style={{padding: 20}}><h4>Le site est en construction,</h4> Il n'y a pas plus d'informations ici pour le moment, vous pouvez toujours nous contacter :<br /><ul><li>Par téléphone au 07 66 40 32 95</li><li>Par email à <a mailto="contact@proapps.fr">contact@proapps.fr</a></li></ul></div>}
